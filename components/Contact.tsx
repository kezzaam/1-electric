...
import MountTown from "./MountTown"
    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center p-6 lg:px-24 lg:py-12 snap-y">
        <section className="flex flex-col items-center text-center snap-center space-y-10">
          ...
          <div>
            <h4 className="text-sm uppercase text-trueblue tracking-wide my-4">Keen to discuss your next project?</h4>
            <h2 className="text-3xl font-bold text-center mb-4">Get in Touch</h2>
            <p className="text-xl text-center mb-8 max-w-2xl">
              It would be great to hear from you.<br/>
              Please complete the form below and we will contact you shortly.<br />

              Alternatively, give us a call or send us an email.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row p-0 lg:mx-10 items-center bg-ghostwhite ">
            ...
            <div className="lg:w-[30%] bg-deepkoamaru lg:rounded-r-xl text-ghostwhite flex flex-col items-center space-y-4 p-4 pb-12">
              ...
              <div className="text-lg">
                ...
                <p>
                  <Link href="mailto:admin@1electric.nz" className="hover:scale-105 hover:transition-all hover:text-trueblue">
                    <span className="flex space-x-2 items-center justify-center"><Mail size={20} /><span>admin@1electric.nz</span></span>
                  </Link>
                </p>
                <p><b>Office Hours:</b> 8am - 5pm Monday to Friday<br/>
