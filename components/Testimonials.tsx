...
const testimonials = [
  {
    quote: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sed vehicula justo.",
    name: "John Doe",
    company: "ABC Inc.",
    image: "/john-doe.jpg", // URL to the customer's photo
  },
  {
...
const Testimonials = () => {
  ...
  return (
    <section className="p-4 lg:p-24 flex flex-col items-center justify-center snap-center">
